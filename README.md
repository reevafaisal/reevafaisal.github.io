...
<div style="display: flex; flex-wrap: wrap; justify-content: space-between;">
  <iframe src="votes_chloropleth.html" width="48%" height="150px" frameborder="0" scrolling="no"></iframe>
  <iframe src="loans_box.html" width="48%" height="150px" frameborder="0" scrolling="no"></iframe>
</div>
<div style="display: flex; flex-wrap: wrap; justify-content: space-between;">
  <iframe src="loans_comp.html" width="48%" height="150px" frameborder="0" scrolling="no"></iframe>
  <iframe src="loans_scatter.html" width="48%" height="150px" frameborder="0" scrolling="no"></iframe>
</div>
